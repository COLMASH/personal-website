...
export async function createTestUser(app: INestApplication, overrides: Record<string, string> = {}) {
  const userData = {
...
export async function getAuthToken(app: INestApplication, email = 'test@example.com', password = 'Test123!@') {
