...
export function ApproachStepCard({ step, index }: ApproachStepProps) {
    ...
    return (
        <motion.div
            ...
            whileHover={{ y: -6, transition: { type: 'spring', stiffness: 200, damping: 12 } }}
            className="group border-border bg-card hover:border-brand-accent/25 relative cursor-default rounded-2xl border p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-[border-color,box-shadow] duration-300 hover:shadow-[0_8px_20px_rgba(0,0,0,0.08)]"
        >
